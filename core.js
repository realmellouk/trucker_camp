...
const FC = {
  ...
  drivers: [
    ...
    { id:'DRV-006', name:'Karim Saidi',          initials:'KS', color:'#ff3b5c', status:'online',   truck:'TRK-033', rating:4.3, trips:420,  earnings:3840, license:'2024-11-14', risk:'high',   city:'Agadir',       phone:'+212 6 16 77 88 99', deliveries:380,  ontime:'85%', miles:31200 },
  ...
  trucks: [
    ...
    { id:'TRK-033', plate:'WA-21876', make:'International',model:'LT Series',year:2022,status:'active', driver:'DRV-006', health:82, mileage:175300, fuel:55, insurance:'2025-08-25', nextService:5400,  type:'Semi',      color:'#ff3b5c' },
  ...
  deliveries: [
    ...
    { id:'DEL-4816', origin:'Casablanca',  dest:'Essaouira',driver:'DRV-006', truck:'TRK-033', status:'transit',   priority:'low',    weight:'7,400 kg',  eta:'2h 15m', revenue:480,  date:'2025-03-17', cargo:'Fournitures de construction', distance:'182 km' },
  ...
  widget.innerHTML = `
    <div class="ai-panel" id="aiPanel">
      ...
      <div class="ai-panel-body">
        ...
        <div class="ai-suggestion" onclick="showToast('warning','Alerte AI','DRV-006 a 3 freinages brusques aujourd’hui. Risque élevé.')">⚠️ Alerte sécurité conducteurs: DRV-006</div>
